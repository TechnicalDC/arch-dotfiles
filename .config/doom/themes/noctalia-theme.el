...
(let* ((bg "#191724")
      (err "#eb6f92")
      (err-container "#961137")
      (on-background "#e0def4")
      (on-err "#191724")
      (on-err-container "#f9d2dd")
      (on-primary "#191724")
      (on-primary-container "#ffe4e3")
      (on-secondary "#191724")
      (on-secondary-container "#030e11")
      (on-surface "#e0def4")
      (on-surface-variant "#908caa")
      (on-tertiary "#e0def4")
      (on-tertiary-container "#d9ebf2")
      (outline-color "#656278")
      (outline-variant "#42404e")
      (primary "#ebbcba")
      (primary-container "#c4342e")
      (secondary "#9ccfd8")
      (secondary-container "#2e8493")
      (shadow "#191724")
      (surface "#191724")
      (surface-container "#26233a")
      (surface-container-high "#2e2b47")
      (surface-container-highest "#373253")
      (surface-container-low "#1f1d2f")
      (surface-container-lowest "#1b1928")
      (surface-variant "#26233a")
      (tertiary "#31748f")
      (tertiary-container "#112f3c")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#31748f")
      (on-success "#e0def4")
      (success-container "#112f3c")
      (on-success-container "#d9ebf2")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ebbcba")
      (primary-fixed-dim "#c4342e")
      (secondary-fixed "#9ccfd8")
      (secondary-fixed-dim "#2e8493")
      (tertiary-fixed "#31748f")
      (tertiary-fixed-dim "#112f3c")
      (on-primary-fixed "#191724")
      (on-primary-fixed-variant "#ffe4e3")
      (on-secondary-fixed "#191724")
      (on-secondary-fixed-variant "#030e11")
      (on-tertiary-fixed "#e0def4")
      (on-tertiary-fixed-variant "#d9ebf2")
