...
(let* ((bg "#120f2e")
      ...
      (on-primary "#0b0915")
      (on-primary-container "#d7d4f7")
      (on-secondary "#13101d")
      (on-secondary-container "#e8d6f5")
      (on-surface "#f2f2f3")
      (on-surface-variant "#afafb6")
      (on-tertiary "#1a1825")
      (on-tertiary-container "#f3d9f0")
      (outline-color "#616074")
      (outline-variant "#3e3d4a")
      (primary "#7367e4")
      ...
      (surface-container-high "#241e5c")
      (surface-container-highest "#2a236c")
      (surface-container-low "#18143d")
      (surface-container-lowest "#141134")
      (surface-variant "#1e194d")
      (tertiary "#cd65c3")
      ...
      (on-primary-fixed-variant "#d7d4f7")
      (on-secondary-fixed "#13101d")
      (on-secondary-fixed-variant "#e8d6f5")
      (on-tertiary-fixed "#1a1825")
      (on-tertiary-fixed-variant "#f3d9f0")
