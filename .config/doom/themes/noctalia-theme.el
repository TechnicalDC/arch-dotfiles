...
(let* ((bg "#000000")
      (err "#ff99b8")
      (err-container "#e60046")
      (on-background "#ffe0eb")
      (on-err "#000000")
      (on-err-container "#fff8fa")
      (on-primary "#000000")
      (on-primary-container "#ffeaf0")
      (on-secondary "#000000")
      (on-secondary-container "#300c1c")
      (on-surface "#ffe0eb")
      (on-surface-variant "#ff8cb3")
      (on-tertiary "#000000")
      (on-tertiary-container "#351122")
      (outline-color "#6e5160")
      (outline-variant "#42313a")
      (primary "#ff8cb3")
      (primary-container "#d90049")
      (secondary "#ffb3cc")
      (secondary-container "#ff0054")
      (shadow "#000000")
      (surface "#000000")
      (surface-container "#1a0f16")
      (surface-container-high "#271621")
      (surface-container-highest "#341e2c")
      (surface-container-low "#0d070b")
      (surface-container-lowest "#050304")
      (surface-variant "#1a0f16")
      (tertiary "#ffcce0")
      (tertiary-container "#ff1a73")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#ffcce0")
      (on-success "#000000")
      (success-container "#ff1a73")
      (on-success-container "#351122")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ff8cb3")
      (primary-fixed-dim "#d90049")
      (secondary-fixed "#ffb3cc")
      (secondary-fixed-dim "#ff0054")
      (tertiary-fixed "#ffcce0")
      (tertiary-fixed-dim "#ff1a73")
      (on-primary-fixed "#000000")
      (on-primary-fixed-variant "#ffeaf0")
      (on-secondary-fixed "#000000")
      (on-secondary-fixed-variant "#300c1c")
      (on-tertiary-fixed "#000000")
      (on-tertiary-fixed-variant "#351122")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#ffe0eb")
      (inverse-primary "#ff8cb3")
