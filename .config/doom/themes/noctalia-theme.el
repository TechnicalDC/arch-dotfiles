...
(let* ((bg "#120f2e")
      (err "#fd4663")
      (err-container "#8f0118")
      (on-background "#f2f2f3")
      (on-err "#1a1825")
      (on-err-container "#fecdd4")
      (on-primary "#0b0915")
      (on-primary-container "#dbd9f2")
      (on-secondary "#13101d")
      (on-secondary-container "#e8d9f2")
      (on-surface "#f2f2f3")
      (on-surface-variant "#afafb6")
      (on-tertiary "#1a1825")
      (on-tertiary-container "#f2d9f0")
      (outline-color "#61606f")
      (outline-variant "#616074")
      (primary "#7367e4")
      (primary-container "#1e1485")
      (secondary "#a35cd6")
      (secondary-container "#47166a")
      (shadow "#120f2e")
      (surface "#120f2e")
      (surface-container "#1e194d")
      (surface-container-high "#1b1745")
      (surface-container-highest "#211c54")
      (surface-container-low "#0f0d26")
      (surface-container-lowest "#090817")
      (surface-variant "#18143d")
      (tertiary "#cd65c3")
      (tertiary-container "#651b5e")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#cd65c3")
      (on-success "#1a1825")
      (success-container "#651b5e")
      (on-success-container "#f2d9f0")
      ;; Map fixed colors to regular colors
      (primary-fixed "#7367e4")
      (primary-fixed-dim "#1e1485")
      (secondary-fixed "#a35cd6")
      (secondary-fixed-dim "#47166a")
      (tertiary-fixed "#cd65c3")
      (tertiary-fixed-dim "#651b5e")
      (on-primary-fixed "#0b0915")
      (on-primary-fixed-variant "#dbd9f2")
      (on-secondary-fixed "#13101d")
      (on-secondary-fixed-variant "#e8d9f2")
      (on-tertiary-fixed "#1a1825")
      (on-tertiary-fixed-variant "#f2d9f0")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f2f2f3")
      (inverse-primary "#7367e4")
      (inverse-surface "#120f2e")
