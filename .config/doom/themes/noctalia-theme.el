...
(let* ((bg "#212337")
      ...
      (on-primary-fixed-variant "#cffce6")
      (on-secondary-fixed "#171928")
      (on-secondary-fixed-variant "#cdf6fe")
      (on-tertiary-fixed "#171928")
      (on-tertiary-fixed-variant "#dbd1fa")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#ebfafa")
      (inverse-primary "#37f499")
      (inverse-surface "#212337")
